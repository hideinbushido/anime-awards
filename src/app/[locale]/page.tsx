    ...
    <>
      ...
      <main>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 overflow-hidden bg-[#03030a]">
          ...
          {/* Anneaux de portail — toujours visibles, CSS animation */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="absolute" style={{ width:'700px', height:'700px', borderRadius:'50%', border:'1px solid rgba(124,58,237,0.2)', boxShadow:'0 0 40px rgba(124,58,237,0.08)', animation:'portal-spin 20s linear infinite' }} />
            <div className="absolute" style={{ width:'520px', height:'520px', borderRadius:'50%', border:'1px solid rgba(168,85,247,0.25)', boxShadow:'0 0 30px rgba(168,85,247,0.1)', animation:'portal-spin-reverse 14s linear infinite' }} />
            <div className="absolute" style={{ width:'360px', height:'360px', borderRadius:'50%', border:'1px solid rgba(236,72,153,0.2)', boxShadow:'0 0 25px rgba(236,72,153,0.1)', animation:'portal-spin 10s linear infinite' }} />
          </div>

          <div className="container-mobile text-center z-10 py-20">

            {/* Badge — fade depuis le haut */}
            <AnimateOnScroll animation="fade-down" delay={150} className="flex justify-center mb-8">
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full text-sm font-semibold tracking-widest uppercase"
                style={{ background:'rgba(124,58,237,0.12)', border:'1px solid rgba(168,85,247,0.35)', color:'#c084fc', boxShadow:'0 0 20px rgba(124,58,237,0.2)', backdropFilter:'blur(10px)' }}
              >
            ...
            <AnimateOnScroll animation="cosmic" delay={350} duration={900}>
              <h1 className="text-5xl sm:text-7xl md:text-9xl font-black mb-4 leading-none tracking-tight">
                <span style={{ background:'linear-gradient(135deg,#c084fc,#ec4899,#818cf8)', backgroundSize:'200% auto', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text', animation:'gradient-shift 6s ease infinite' }}>Anime</span>
                <br />
                <span className="text-white" style={{ textShadow:'0 0 50px rgba(124,58,237,0.5), 0 0 100px rgba(236,72,153,0.2)' }}>Awards</span>
              </h1>
            </AnimateOnScroll>

            {/* Séparateur + edition — fade up */}
        ...
        <section className="relative py-20 overflow-hidden" style={{
          ...
          <div className="container-mobile relative z-10">
            ...
            <AnimateOnScroll animation="fade-down" threshold={0.2}>
              <div className="text-center mb-12">
                <h2 className="text-3xl sm:text-4xl font-black mb-3">
                  <span style={{ background:'linear-gradient(135deg,#c084fc,#ec4899)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>
                    {t('howItWorks.title')}
                  </span>
                </h2>
            ...
            {/* Cards — apparition échelonnée du bas */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
              {[
                ...
                <AnimateOnScroll key={i} animation="fade-up" delay={i * 160} threshold={0.1}>
                  <Link href={item.href}
                    className="group border rounded-2xl p-8 card-glow text-center relative overflow-hidden block"
                    style={{ background:'rgba(8,5,26,0.7)', borderColor:'rgba(124,58,237,0.2)', backdropFilter:'blur(14px)' }}
                  >
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-2xl"
                      style={{ background:`radial-gradient(ellipse at center, ${item.glow.replace('0.3','0.06')} 0%, transparent 70%)` }} />
                    <div className="text-6xl font-black mb-4 relative z-10" style={{ color:'rgba(168,85,247,0.1)' }}>{item.step}</div>
        ...
        >
          ...
          <div className="container-mobile relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              {/* GAUCHE — photos : glissent depuis la gauche */}
              ...
              >
                ...
                <div className="group relative flex flex-col items-center gap-4">
                  <div className="w-56 h-72 sm:w-64 sm:h-80 rounded-2xl overflow-hidden flex items-center justify-center transition-all duration-300 group-hover:scale-105"
                    style={{ border:'1px solid rgba(168,85,247,0.45)', background:'rgba(8,5,26,0.75)', boxShadow:'0 0 0 1px rgba(124,58,237,0.15), 0 20px 50px rgba(124,58,237,0.2)', backdropFilter:'blur(14px)' }}
                  >
                ...
                <div className="group relative flex flex-col items-center gap-4">
                  <div className="w-56 h-72 sm:w-64 sm:h-80 rounded-2xl overflow-hidden flex items-center justify-center transition-all duration-300 group-hover:scale-105"
                    style={{ border:'1px solid rgba(236,72,153,0.4)', background:'rgba(8,5,26,0.75)', boxShadow:'0 0 0 1px rgba(236,72,153,0.15), 0 20px 50px rgba(236,72,153,0.18)', backdropFilter:'blur(14px)' }}
                  >
                    <div className="flex flex-col items-center gap-3 opacity-40">
              ...
              {/* DROITE — texte : glisse depuis la droite, décalé */}
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-6"
                  style={{ background:'rgba(124,58,237,0.12)', border:'1px solid rgba(168,85,247,0.35)', color:'#c084fc', boxShadow:'0 0 15px rgba(124,58,237,0.18)', backdropFilter:'blur(8px)' }}
                >
        ...
        <section className="relative py-20 overflow-hidden" style={{
          ...
          <div className="container-mobile relative z-10">
            ...
            {/* Card portail entière — cosmic reveal */}
            <AnimateOnScroll animation="cosmic" threshold={0.15}>
              <div className="relative rounded-3xl p-8 sm:p-12 text-center overflow-hidden"
                style={{ background:'rgba(8,5,26,0.75)', border:'1px solid rgba(168,85,247,0.28)', boxShadow:'0 0 0 1px rgba(124,58,237,0.1), 0 0 80px rgba(124,58,237,0.12), 0 0 40px rgba(236,72,153,0.06)', backdropFilter:'blur(18px)' }}
              >
                {/* Glow interne */}
                ...
                {/* Icône TikTok avec anneaux rotatifs */}
                <AnimateOnScroll animation="portal-in" delay={200} className="flex justify-center">
                  <div className="relative w-20 h-20 mb-6">
                    <div className="absolute inset-0 rounded-full pointer-events-none" style={{ border:'1px solid rgba(168,85,247,0.4)', animation:'portal-spin 6s linear infinite' }} />
                    <div className="absolute inset-1 rounded-full pointer-events-none" style={{ border:'1px solid rgba(236,72,153,0.3)', animation:'portal-spin-reverse 4s linear infinite' }} />
                    <div className="absolute inset-0 rounded-full flex items-center justify-center"
                      style={{ background:'rgba(8,5,26,0.9)', border:'1px solid rgba(168,85,247,0.35)', boxShadow:'0 0 25px rgba(124,58,237,0.3)' }}
                    >
                ...
                <AnimateOnScroll animation="fade-up" delay={500}>
                  <p className="text-[#9580b0] max-w-xl mx-auto mb-8">{t('tiktok.subtitle')}</p>
                </AnimateOnScroll>

                {/* Bouton — portal bounce */}
                <AnimateOnScroll animation="scale-in" delay={700} className="flex justify-center">
                  <a href="https://www.tiktok.com/@ricokouame" target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-white transition-all btn-gold"
                    style={{ boxShadow:'0 0 30px rgba(124,58,237,0.45), 0 0 60px rgba(236,72,153,0.2)' }}
                  >
