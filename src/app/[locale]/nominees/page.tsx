...
const PLACEHOLDER_NOMINEES: Record<string, Nominee[]> = {
  ...
  'p-sensei': [
    n('se1','p-sensei','Enjin','To Be Hero X','','0a0a20','60a0ff'),
    n('se2','p-sensei','Zanka','Bleach TYBW','','0a0a14','6080ff'),
    n('se3','p-sensei','Tsukasa Akeuraji','Medalist','','0a0a1a','a0c0ff'),
    n('se4','p-sensei','Shota Aizawa','My Hero Academia','','0d0d0d','888888'),
    ...
    n('se8','p-sensei','All Might','My Hero Academia','','1a0500','ff4020'),
  ...
  'p-chara': [
    ...
    n('cha5','p-chara','Dr. Stone SCIENCE FUTURE','','','0a1008','80e880'),
    n('cha6','p-chara','The Apothecary Diaries S2','','','0a0a14','c9a227'),
    ...
    n('cha12','p-chara','Solo Leveling S2','','','1a0800','ffd250'),
    n('cha13','p-chara','Dandadan S2','','','0a0a20','a060ff'),
  ],
  'p-attachant': [
    n('at1','p-attachant','Anya Forger','Spy × Family','','0a0a14','ff80b4'),
    n('at2','p-attachant','Bonney','One Piece','','1a0a14','ff80b4'),
    n('at3','p-attachant','Suika','Dr. Stone','','0a1008','80e880'),
    n('at4','p-attachant','Kaoruko','Bloom','','0a1414','80e0c0'),
    n('at5','p-attachant','Amo','Gachiakuta','','1a0800','ff8030'),
    n('at6','p-attachant','Inori Yuitsuka','Medalist','','0a0a1a','a0c0ff'),
  ],
  'p-film': [
    n('fil1','p-film','Demon Slayer The Movie — Infinity Castle','','','1a0800','ff8060'),
    n('fil2','p-film','Chainsaw Man The Movie — Reze Arc','','','100010','c000ff'),
  ...
  'p-chanson': [
    n('cs1','p-chanson','"Flaming Thunder God (Zenitsu\'s Theme)" — Demon Slayer: Infinity Castle','Yuki Kajiura','','1a0800','ff8060'),
    n('cs2','p-chanson','"New Type of Hero" — To Be Hero X','Chatterbox','','0a0a20','60a0ff'),
    n('cs3','p-chanson','"Momentum In My Veins" — Gachiakuta','Taku Iwasaki feat. Lotus Juice','','1a0800','ff8030'),
    n('cs4','p-chanson','"Outlaws Get No Entry" — Gachiakuta','Gachiakuta OST','','1a0800','ff8030'),
    n('cs5','p-chanson','"A World Where the Sun Never Rises" — Demon Slayer: Infinity Castle','Aimer','','1a0800','ff8060'),
    n('cs6','p-chanson','"Hunting Soul" — Dandadan S2','HAYASii','','0a0a20','a060ff'),
  ],
  'p-protagoniste': [
  ...
  'p-antagoniste': [
    ...
    n('ag7','p-antagoniste','Yhwach','Bleach BTW','','0a0a14','6080ff'),
    ...
    n('ag13','p-antagoniste','Sherlock Holmes','Moriarty the Patriot','','0a0a14','c9a227'),
