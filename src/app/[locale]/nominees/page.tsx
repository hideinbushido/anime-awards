...
const PLACEHOLDER_NOMINEES: Record<string, Nominee[]> = {
  ...
  'p-protagoniste': [
    ...
    n('pr2','p-protagoniste','Gojo & Marin','Jujutsu Kaisen / My Dress-Up Darling','','0a0a20','6060ff'),
    n('pr4','p-protagoniste','Cheng Xiaoshi & Lu Guang','Link Click','','0a0a20','6080ff','/image/PROTA/Cheng.png'),
  ...
  'p-suite': [
    ...
    n('su4','p-suite','Dr. Stone S4','','','0a1008','80e880','/image/SUITE/Stone.png'),
