...
const PLACEHOLDER_NOMINEES: Record<string, Nominee[]> = {
  ...
  'p-combat': [
    n('cb1','p-combat','Luffy vs Kizaru','One Piece','','1a0800','ff7030','/image/COMBAT/LuffyvsKiza.png'),
    n('cb2','p-combat','Jinwoo vs Beru','Solo Leveling','','1a0800','ffd250','/image/COMBAT/JinvsBer.png'),
    ...
    n('cb5','p-combat','Zenitsu vs Kaigaku','Demon Slayer: Infinity Castle','','1a0800','ff8060','/image/COMBAT/ZenvsKai.png'),
  ...
  'p-opening': [
    ...
    n('op13','p-opening','"Shounen" — Danmachi S5 OP','GRe4N BOYZ','','100814','8040c0','/image/OPENING/Shounen.png'),
    n('op15','p-opening','"Same Blue" — Blue Box OP','Official HIGE DANdism','','0a0a1a','80c0ff','/image/OPENING/Sameblue.png'),
  ],
  'p-ending': [
