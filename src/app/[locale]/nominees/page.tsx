...
const PLACEHOLDER_NOMINEES: Record<string, Nominee[]> = {
  ...
  'p-masculin': [
    n('m1','p-masculin','— À venir —','','','0d0d0d','555555'),
  ],
  'p-feminin': [
    n('f1','p-feminin','— À venir —','','','0d0d0d','555555'),
  ],
  'p-deception': [
  ...
  'p-protagoniste': [
    n('pr1','p-protagoniste','— À venir —','','','0d0d0d','555555'),
  ],
  'p-secondaire': [
  ...
  'p-antagoniste': [
    n('ag1','p-antagoniste','— À venir —','','','0d0d0d','555555'),
  ],
};
