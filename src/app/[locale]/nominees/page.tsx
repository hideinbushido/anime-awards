...
export const PLACEHOLDER_CATEGORIES: Category[] = [
  { id: 'p-deception',   eventId: 'demo', title: 'Déception de l\'Année',           titleFr: 'Déception de l\'Année',           titleEn: 'Disappointment of the Year',    description: '', descriptionFr: 'L\'animé qui a le plus déçu',                  descriptionEn: 'The most disappointing anime',                order: 1,  active: true },
  { id: 'p-comedie',     eventId: 'demo', title: 'Meilleure Comédie',               titleFr: 'Meilleure Comédie',               titleEn: 'Best Comedy',                   description: '', descriptionFr: 'L\'animé qui a le plus fait rire',             descriptionEn: 'The anime that made us laugh the most',       order: 2,  active: true },
  { id: 'p-sol',         eventId: 'demo', title: 'Meilleur Slice of Life',          titleFr: 'Meilleur Slice of Life',          titleEn: 'Best Slice of Life',            description: '', descriptionFr: 'Le quotidien le plus touchant',                descriptionEn: 'The most touching everyday life',             order: 3,  active: true },
  { id: 'p-romance',     eventId: 'demo', title: 'Meilleure Romance',               titleFr: 'Meilleure Romance',               titleEn: 'Best Romance',                  description: '', descriptionFr: 'La plus belle histoire d\'amour',               descriptionEn: 'The most beautiful love story',               order: 4,  active: true },
  { id: 'p-isekai',      eventId: 'demo', title: 'Meilleur Isekai',                 titleFr: 'Meilleur Isekai',                 titleEn: 'Best Isekai',                   description: '', descriptionFr: 'Le meilleur voyage vers un autre monde',       descriptionEn: 'The best journey to another world',           order: 5,  active: true },
  { id: 'p-seinen',      eventId: 'demo', title: 'Meilleur Seinen',                 titleFr: 'Meilleur Seinen',                 titleEn: 'Best Seinen',                   description: '', descriptionFr: 'Le meilleur seinen de l\'année',               descriptionEn: 'The best seinen of the year',                 order: 6,  active: true },
  { id: 'p-drama',       eventId: 'demo', title: 'Meilleur Drama',                  titleFr: 'Meilleur Drama',                  titleEn: 'Best Drama',                    description: '', descriptionFr: 'Le drama le plus marquant',                      descriptionEn: 'The most impactful drama',                    order: 7,  active: true },
  { id: 'p-chara',       eventId: 'demo', title: 'Meilleur Chara-Design',           titleFr: 'Meilleur Chara-Design',           titleEn: 'Best Character Design',         description: '', descriptionFr: 'Le design de personnage le plus réussi',       descriptionEn: 'The most successful character design',        order: 8,  active: true },
  { id: 'p-animation',   eventId: 'demo', title: 'Meilleure Animation',             titleFr: 'Meilleure Animation',             titleEn: 'Best Animation',                description: '', descriptionFr: 'La qualité visuelle la plus époustouflante',   descriptionEn: 'The most breathtaking visual quality',        order: 9,  active: true },
  { id: 'p-nouveaute',   eventId: 'demo', title: 'Meilleure Nouveauté',             titleFr: 'Meilleure Nouveauté',             titleEn: 'Best New Series',               description: '', descriptionFr: 'La nouvelle série la plus prometteuse',        descriptionEn: 'The most promising new series',               order: 10, active: true },
  { id: 'p-suite',       eventId: 'demo', title: 'Meilleure Suite',                 titleFr: 'Meilleure Suite',                 titleEn: 'Best Sequel',                   description: '', descriptionFr: 'La suite qui a le mieux honoré l\'original',   descriptionEn: 'The sequel that best honored the original',   order: 11, active: true },
  { id: 'p-attachant',   eventId: 'demo', title: 'Personnage le Plus Attachant',    titleFr: 'Personnage le Plus Attachant',    titleEn: 'Most Lovable Character',        description: '', descriptionFr: 'Le personnage qu\'on a le plus adoré',         descriptionEn: 'The character we loved the most',             order: 12, active: true },
  { id: 'p-feminin',     eventId: 'demo', title: 'Meilleur Personnage Féminin',     titleFr: 'Meilleur Personnage Féminin',     titleEn: 'Best Female Character',         description: '', descriptionFr: 'Le personnage féminin le plus marquant',       descriptionEn: 'The most iconic female character',            order: 13, active: true },
  { id: 'p-secondaire',  eventId: 'demo', title: 'Meilleur Personnage Secondaire',  titleFr: 'Meilleur Personnage Secondaire',  titleEn: 'Best Supporting Character',     description: '', descriptionFr: 'Le perso secondaire le plus mémorable',        descriptionEn: 'The most memorable supporting character',     order: 14, active: true },
  { id: 'p-masculin',    eventId: 'demo', title: 'Meilleur Personnage Masculin',    titleFr: 'Meilleur Personnage Masculin',    titleEn: 'Best Male Character',           description: '', descriptionFr: 'Le personnage masculin le plus marquant',      descriptionEn: 'The most iconic male character',              order: 15, active: true },
  { id: 'p-antagoniste', eventId: 'demo', title: 'Meilleur Antagoniste',            titleFr: 'Meilleur Antagoniste',            titleEn: 'Best Antagonist',               description: '', descriptionFr: 'Le méchant qu\'on a adoré détester',           descriptionEn: 'The villain we loved to hate',                order: 16, active: true },
  { id: 'p-protagoniste',eventId: 'demo', title: 'Meilleur Protagoniste',           titleFr: 'Meilleur Protagoniste',           titleEn: 'Best Protagonist',              description: '', descriptionFr: 'Le héros le plus marquant',                    descriptionEn: 'The most memorable hero',                     order: 17, active: true },
  { id: 'p-film',        eventId: 'demo', title: 'Meilleur Film d\'Animation',      titleFr: 'Meilleur Film d\'Animation',      titleEn: 'Best Animated Film',            description: '', descriptionFr: 'Le meilleur film anime de l\'année',           descriptionEn: 'The best animated film of the year',          order: 18, active: true },
  { id: 'p-chanson',     eventId: 'demo', title: 'Meilleure Chanson d\'Animé',      titleFr: 'Meilleure Chanson d\'Animé',      titleEn: 'Best Anime Song',               description: '', descriptionFr: 'La chanson qu\'on a le plus écoutée',          descriptionEn: 'The song we listened to the most',            order: 19, active: true },
  { id: 'p-ending',      eventId: 'demo', title: 'Meilleur Ending',                 titleFr: 'Meilleur Ending',                 titleEn: 'Best Ending',                   description: '', descriptionFr: 'L\'ending le plus marquant',                   descriptionEn: 'The most impactful ending',                   order: 20, active: true },
  { id: 'p-opening',     eventId: 'demo', title: 'Meilleur Opening',                titleFr: 'Meilleur Opening',                titleEn: 'Best Opening',                  description: '', descriptionFr: 'L\'opening le plus mémorable',                 descriptionEn: 'The most memorable opening',                  order: 21, active: true },
  { id: 'p-action',      eventId: 'demo', title: 'Meilleur Animé d\'Action',        titleFr: 'Meilleur Animé d\'Action',        titleEn: 'Best Action Anime',             description: '', descriptionFr: 'L\'action la plus explosive',                  descriptionEn: 'The most explosive action',                   order: 22, active: true },
  { id: 'p-combat',      eventId: 'demo', title: 'Meilleur Combat',                 titleFr: 'Meilleur Combat',                 titleEn: 'Best Fight',                    description: '', descriptionFr: 'Le combat le plus épique de l\'année',         descriptionEn: 'The most epic fight of the year',             order: 23, active: true },
  { id: 'p-sensei',      eventId: 'demo', title: 'Meilleur Sensei',                 titleFr: 'Meilleur Sensei',                 titleEn: 'Best Sensei',                   description: '', descriptionFr: 'Le maître ou professeur le plus inspirant',    descriptionEn: 'The most inspiring teacher',                  order: 24, active: true },
  { id: 'p-annee',       eventId: 'demo', title: 'Animé de l\'Année',              titleFr: 'Animé de l\'Année',              titleEn: 'Anime of the Year',             description: '', descriptionFr: 'Le grand prix — meilleur animé 2025',          descriptionEn: 'The grand prize — best anime 2025',           order: 25, active: true },
];
...
export const PLACEHOLDER_NOMINEES: Record<string, Nominee[]> = {
  ...
  'p-masculin': [
    n('mas1','p-masculin','Bakugo','My Hero Academia — Final Season','','1a0500','ff4020','/image/MASCULIN/Bakugo.png'),
    n('mas2','p-masculin','X','To Be Hero X','','0a0a20','60a0ff','/image/MASCULIN/X.png'),
    n('mas3','p-masculin','Akaza','Demon Slayer: The Movie — Infinity Castle','','200010','ff4060','/image/MASCULIN/Akaza.png'),
    n('mas4','p-masculin','Denji','Chainsaw Man: The Movie — Reze Arc','','100010','c000ff','/image/MASCULIN/Denji.png'),
    n('mas9','p-masculin','Senku','Dr.STONE SCIENCE FUTURE','','0a1008','80e880','/image/MASCULIN/Senku.png'),
    n('mas11','p-masculin','Xeno','Dr.STONE SCIENCE FUTURE','','0a1008','ffd250','/image/MASCULIN/Xeno.png'),
    n('mas12','p-masculin','Lin Ling','To Be Hero X','','0a0a1a','a0c0ff','/image/MASCULIN/Lin.png'),
    n('mas15','p-masculin','Shigaraki','My Hero Academia — Final Season','','100010','a000ff','/image/MASCULIN/Shigaraki.png'),
    n('mas16','p-masculin','Sung Jinwoo','Solo Leveling S2','','1a0800','ffd250','/image/MASCULIN/Jinwoo.png'),
    n('mas17','p-masculin','Sakura','Wind Breaker S2','','0a0a20','a060ff','/image/MASCULIN/Sakura.png'),
  ...
  'p-feminin': [
    ...
    n('fem3','p-feminin','Marin Kitagawa','My Dress-Up Darling S2','','1a0a14','ff80b4','/image/FEMININ/Marin.png'),
    n('fem4','p-feminin','Maomao','The Apothecary Diaries S2','','0a0a14','c9a227','/image/FEMININ/Maomao.png'),
    n('fem10','p-feminin','Riyo','Gachiakuta','','0a0a20','6080ff','/image/FEMININ/Riyo.png'),
    n('fem13','p-feminin','Reze','Chainsaw Man: The Movie — Reze Arc','','100010','c000ff','/image/FEMININ/Reze.png'),
    n('fem14','p-feminin','Toga Himiko','My Hero Academia — Final Season','','1a0a14','ff80b4','/image/FEMININ/Toga.png'),
    ...
    n('fem18','p-feminin','Alicia Glenfall','Clevatess','','0a0a1a','a0c0ff','/image/FEMININ/Alicia.png'),
    n('fem19','p-feminin','Momo Ayase','Dandadan S2','','0a0a20','a060ff','/image/FEMININ/Momo.png'),
    n('fem20','p-feminin','Ochaco Uraraka','My Hero Academia — Final Season','','1a0500','ff80b4','/image/FEMININ/Uraraka.png'),
  ],
  'p-combat': [
    n('cb1','p-combat','Luffy vs Kizaru','One Piece (Egghead Arc)','','1a0800','ff7030','/image/COMBAT/LuffyvsKiza.png'),
    n('cb2','p-combat','Jinwoo vs Beru','Solo Leveling S2','','1a0800','ffd250','/image/COMBAT/JinvsBer.png'),
    n('cb3','p-combat','Bakugo vs All For One','My Hero Academia — Final Season','','1a0500','ff4020','/image/COMBAT/BakvsAFO.png'),
    n('cb4','p-combat','Wang vs Mushan','Super Cube','','0a0a20','60a0ff','/image/COMBAT/WangvsMush.png'),
    n('cb5','p-combat','Zenitsu vs Kaigaku','Demon Slayer: The Movie — Infinity Castle','','1a0800','ff8060','/image/COMBAT/ZenvsKai.png'),
    n('cb6','p-combat','Queen vs Bowa','To Be Hero X','','0a0a20','60a0ff','/image/COMBAT/QueenvsBoa.png'),
    n('cb7','p-combat','Reze vs Denji','Chainsaw Man: The Movie — Reze Arc','','100010','c000ff','/image/COMBAT/RezevsDenji.png'),
  ...
  'p-comedie': [
    ...
    n('com9','p-comedie','Witch Watch','','','1a0a14','ff80b4','/image/COMEDIE/Witch.png'),
    n('com10','p-comedie','Ranma 1/2 Remake','','','1a0500','ff4060','/image/COMEDIE/Ranma.png'),
  ...
  'p-chara': [
    ...
    n('cha2','p-chara','Takopi\'s Original Sin','','','0a0a0a','ff80b4','/image/CHARA-DESIGN/Takopi.png'),
  ...
  'p-attachant': [
    n('at1','p-attachant','Anya Forger','Spy × Family S3','','0a0a14','ff80b4','/image/ATTACHANT/Anya.png'),
    n('at2','p-attachant','Bonney','One Piece (Egghead Arc)','','1a0a14','ff80b4','/image/ATTACHANT/Bonney.png'),
    n('at3','p-attachant','Suika','Dr.STONE SCIENCE FUTURE ','','0a1008','80e880','/image/ATTACHANT/Suika.png'),
  ...
  'p-film': [
    ...
    n('fil9','p-film','Mononoke, le film : Chapitre II - Les cendres de la rage','','','1a0800','ff8030','/image/FILM/Mononoke.png'),
  ],
  'p-opening': [
  ...
  'p-chanson': [
    n('cs1','p-chanson','"Flaming Thunder God (Zenitsu\'s Theme)" — Diego Mitre','Demon Slayer: The Movie — Infinity Castle','','1a0800','ff8060','/image/CHANSON/Flaming.png','/music/Chanson/Zenitsu.MP3'),
    ...
    n('cs8','p-chanson',"Thème d'Akaza — Yuki Kajiura",'Demon Slayer: The Movie — Infinity Castle','','200010','ff4060','/image/CHANSON/Akaza.png','/music/Chanson/akazatheme.MP3'),
    n('cs9','p-chanson','"Jana Doe" — Kenshi Yonezu & Hikaru Utada','Chainsaw Man: The Movie — Reze Arc','','100010','c000ff','/image/CHANSON/JANA.png','/music/Chanson/JANA.MP3'),
    n('cs10','p-chanson','"Iris Out" — Kenshi Yonezu','Chainsaw Man: The Movie — Reze Arc','','100010','c000ff','/image/CHANSON/IRIS.png','/music/Chanson/IRIS.MP3'),
  ],
  'p-protagoniste': [
    n('pr1','p-protagoniste','Denji','Chainsaw Man: The Movie — Reze Arc','','100010','c000ff','/image/PROTA/Denji.png'),
    n('pr2','p-protagoniste','Gojo & Marin','My Dress-Up Darling S2','','0a0a20','6060ff','/image/PROTA/Gojo&Mar.png'),
    n('pr4','p-protagoniste','Cheng Xiaoshi & Lu Guang','Link Click S3','','0a0a20','6080ff','/image/PROTA/Chen&Lu.png'),
  ...
  'p-secondaire': [
    ...
    n('sc2','p-secondaire','Shi Huang Di','Valkyrie Apocalypse','','100814','8040c0','/image/SECONDAIRE/Shi.png'),
    n('sc3','p-secondaire','Bakugo','My Hero Academia — Final Season','','1a0500','ff4020','/image/SECONDAIRE/Bak.png'),
    ...
    n('sc7','p-secondaire','Jiji','Dandadan S2','','0a0a20','a060ff','/image/SECONDAIRE/Jiji.png'),
    ...
    n('sc11','p-secondaire','Seiko Ayase','Dandadan S2','','0a0a20','a060ff','/image/SENSEI/Seiko.png'),
  ...
  'p-antagoniste': [
    ...
    n('ag11','p-antagoniste','Zodyl','Gachiakuta','','0a0a1a','80c0ff','/image/ANTAGONISTE/Zodyl.png'),
